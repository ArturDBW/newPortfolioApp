...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 left-0 flex h-screen w-25 flex-col items-center justify-between border-r border-[#e6e6e6] bg-white py-12 text-[#011933]">
      ...
      <nav className="rotate-270 text-sm font-bold tracking-widest uppercase">
        <ul className="flex space-x-10">
          <Link href="/contact">
            <li
              className={`${
                isActive("/contact") ? "text-[#222222]" : "text-[#aaaaaa]"
              } transition-all hover:text-[#222222]`}
            >
              Contact
            </li>
          </Link>
          <Link href="/technologies">
            <li
              className={`${
                isActive("/technologies") ? "text-[#222222]" : "text-[#aaaaaa]"
              } transition-all hover:text-[#222222]`}
            >
              Technologies
            </li>
          ...
          <Link href="/portfolio">
            <li
              className={`${
                isActive("/portfolio") ? "text-[#222222]" : "text-[#aaaaaa]"
              } transition-all hover:text-[#222222]`}
            >
              Portfolio
            </li>
