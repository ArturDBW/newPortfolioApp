export default function DetailsButton() {
  return (
    <button className="group absolute bottom-20 left-1/2 inline-flex -translate-x-1/2 -translate-y-1/2 cursor-pointer items-center justify-center px-28 text-lg tracking-wider text-[#eee] uppercase transition-colors duration-500 hover:text-white">
